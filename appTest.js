...
function executeFolderModule(mainDir) {
  ...
  for (const folder of moduleFolder) {
    // NON CARICO YOUTUBE SYSTEM E TWITCH SYSTEM IN FASE DI TESTING 
    // PER EVITARE CHE IL TOKEN CREI PROBLEMI CON L'APP IN PRODUZIONE
    if(folder != "twitch-system" && folder != "youtube-system") {
...
client.once(Events.ClientReady, readyClient => {
  console.clear();
  console.log('-------------------------------------');
  console.log('TESTING APPLICATION VERSION')
